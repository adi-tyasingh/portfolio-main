        ...
        >
          <div className="antialiased group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              ...
              <span> I am a software engineer focused on backend development, blending technical creativity with a rigorous problem-solving mindset to build resilient production systems. Bridging strong academic foundations with hands-on industry experience, I thrive on adaptability—whether it&apos;s designing scalable architectures, engineering robust APIs, or evolving with new technologies. </span> <span> I approach complex engineering challenges with determination, writing clean, maintainable code that ensures reliability under heavy workloads. Driven by a commitment to engineering excellence, I focus on delivering elegant, scalable solutions that meet the dynamic demands of modern environments. </span>
